...
function updateTimer() {
  ...
  const time = convertMs(differenceMilliseconds);
  ...
  timerFields.forEach(timerField => updateTimerFields(timerField, time));
...
function updateTimerFields(timerField, { days, hours, minutes, seconds }) {
  if (timerField.dataset.hasOwnProperty('seconds')) {
    timerField.textContent = addLeadingZero(seconds);
  } else if (timerField.dataset.hasOwnProperty('minutes')) {
    timerField.textContent = addLeadingZero(minutes);
  } else if (timerField.dataset.hasOwnProperty('hours')) {
    timerField.textContent = addLeadingZero(hours);
  } else if (timerField.dataset.hasOwnProperty('days')) {
